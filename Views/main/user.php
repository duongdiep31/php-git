                    ...
                    <div class="col col-xs-12">
                        <div class="instagram-inner">
                            ...
                            <div class="instagram-grids clearfix">
                                <div class="grid">
                                    <a href="#"><img src="<?= LIB ?>/images/instagram/1.jpg" alt></a>
                                </div>
                                <div class="grid">
                                    <a href="#"><img src="<?= LIB ?>/images/instagram/3.jpg" alt></a>
                                </div>
                                <div class="grid">
                                    <a href="#"><img src="<?= LIB ?>/images/instagram/4.jpg" alt></a>
                                </div>
                                <div class="grid">
                                    <a href="#"><img src="<?= LIB ?>/images/instagram/2.jpg" alt></a>
                                </div>
                                <div class="grid">
                                    <a href="#"><img src="<?= LIB ?>/images/instagram/5.jpg" alt></a>
                                </div>
                                <div class="grid">
                                    <a href="#"><img src="<?= LIB ?>/images/instagram/6.jpg" alt></a>
                                </div>
                            </div>
                        </div>
                    </div>
